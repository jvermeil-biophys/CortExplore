//dirDst = "D:/MicroscopyData/2024-02-27_SpinningDisc_3T3-LifeAct_wPincher_JV/ZStacksForPPT/C13/";
dirDst = "E:/24-05-24_SpinningDisc_PincherFluo/M1-mixed/cleanOrthoViews/";
cellId = "C6_15um";
...
saveAs("TIFF", dirDst + cellId + "_XZview.tif");
...
saveAs("TIFF", dirDst + cellId + "_YZview.tif");
