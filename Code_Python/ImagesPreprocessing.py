...
date = '24.07.18'
DirExt = 'E:/Eloise/Data/24-07-18_helafucci_100x_450beads_PLL/24-07-18_M1_P2_PLL' #'/M4_patterns_ctrl' // \\M1_depthos
DirSave = os.path.join(cp.DirDataRaw, date + '_P2') #  + '_depthos', 'M2' # + '_Deptho', 'M3' //   + '_Deptho', 'M6-7'
