...
NanoIndentTask = '23-11-13 & 23-11-15'
res = taka2.computeGlobalTable_meca(mode = 'fromScratch', task = NanoIndentTask, fileName = 'MecaData_NanoIndent_23-11', 
                                    save = True, PLOT = True, source = 'Python', 
                                    fitSettings = fitSettings,
                                    plotSettings = plotSettings) # task = 'updateExisting'
...
drugTask = '22-03-28 & 22-03-30 & 22-11-23 & 23-02-16 & 23-03 & 23-04-20 & 23-09-19'
res = taka2.computeGlobalTable_meca(mode = 'fromScratch', task = drugTask, fileName = 'MecaData_Drugs_V2', 
                                    save = True, PLOT = True, source = 'Python', 
                                    fitSettings = fitSettings,
                                    plotSettings = plotSettings) # task = 'updateExisting'
