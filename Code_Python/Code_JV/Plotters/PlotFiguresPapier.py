...
ax.axhline(y=median, color = c2, ls = '--', lw = 1.5, zorder = 4)
ax.axhline(y=d1, color = c3, ls = '--', lw = 0.75)
ax.axhline(y=d9, color = c3, ls = '--', lw = 0.75)
...
ax.set_yticks(np.array([200, 400 ,600, 800]))
