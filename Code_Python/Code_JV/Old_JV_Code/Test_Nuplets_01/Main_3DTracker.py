...
dictPaths = {'PathRawDataDir' : 'D://MagneticPincherData//Raw//24.02.27_Chameleon//Clean//Test',
             'PathDeptho'     : 'D://MagneticPincherData//Raw//DepthoLibrary//24.02.27_Chameleon_M450_step20_100X_Deptho.tif', # 
             'PathResultsDir' : 'D://MagneticPincherData//Raw//24.02.27_Chameleon//Clean//Test_results',
             }
...
dictConstants = {'bead_type' : 'M450', # 'M450' or 'M270'
                 ...
                 'multi_images' : 11, # Number of images
                 'multi_image_Z_step' : 400, # nm
                 'multi_image_Z_direction' : 'upward', # Either 'upward' or 'downward'
                 'scale_pixel_per_um' : 7.4588, # 15.8, # pixel/µm
