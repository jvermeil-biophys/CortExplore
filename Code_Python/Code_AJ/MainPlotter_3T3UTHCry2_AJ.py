...
Task = '24-01-02'
fitsSubDir = 'Chad_f15_24-01-02_24-01-29'
...
GlobalTable = taka.getMergedTable('Chad_f15_24-01-02_24-01-29')
fitsSubDir = 'Chad_f15_24-01-02_24-01-29'
...
styleDict1 =  {'M1':{'color':   "#000000",'marker':'o', 'label':'Ctrl'},
                'M2':{'color':   gs.colorList40[20],'marker':'o', 'label':'Doxy, no activation'},
                'M3':{'color':   gs.colorList40[21],'marker':'o', 'label':'Global activation'},
                }
...
df = dfAllCells.drop_duplicates(subset = measure)

makeBoxPlots(df, measure, condCol, labels, order, condSelection, savePath = savePath,
                   stats = False, average = False)
