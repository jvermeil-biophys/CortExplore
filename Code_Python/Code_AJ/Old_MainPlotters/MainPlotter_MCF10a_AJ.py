...
allCells = os.listdir(cp.DirDataRaw + '/24.01.25_Thickness')
beadDia = 4.510
rawTrajs = os.listdir(cp.DirDataTimeseriesTraj)

rawTrajs = np.asarray([i for i in rawTrajs if '24-01-25' and 'thickness' in i])
...
#%% Thickness plots together
plt.style.use('seaborn')

beadDia = 4.510
rawTrajs = os.listdir(cp.DirDataTimeseriesTraj)

allCells = np.asarray(['24-01-25_M1_P4_C6_disc20um_thickness.tif', 
                       '24-01-25_M1_P2_C7_disc20um_thickness.tif',
                        '24-01-25_M1_P2_C8_disc20um_thickness.tif',
                        '24-01-25_M2_P4_C1_disc20um_thickness.tif',
                        '24-01-25_M2_P1_C1_disc20um_thickness.tif', 
                        '24-01-25_M1_P4_C6_disc20um_thickness.tif',
                        '24-01-24_M1_P1_C1_dumbbell_6um.tif',
                        '24-01-25_M1_P2_C9_disc20um_thickness.tif',])
color = ['green', 'red', 'blue', 'blue', 'green', 'green', 'red', 'blue']


# allCells = np.asarray(['24-01-25_M1_P2_C6_disc20um_thickness.tif', 
#                        '24-01-25_M1_P4_C6_disc20um_thickness.tif', 
#                        '24-01-25_M1_P2_C7_disc20um_thickness.tif'] )
                       # '24-01-25_M1_P2_C8_disc20um_thickness.tif',
                       # '24-01-25_M2_P4_C1_disc20um_thickness.tif', 
...
# color = ['blue', 'green', 'red'] #, 'blue', 'blue', 'green', 'green', 'red']
...
for i in range(len(allCells)):
    ...
    cell = cell.split('.tif')
    cell = cell[0] 
    tsdf = pd.read_csv(cp.DirDataTimeseries + '/' + cell + '_PY.csv', sep = ';')

    
    D3 = (tsdf['D3'] - beadDia)   
    
    # plt.plot(tsdf['T'], D3, label = 'D3', color = color[i])
    name = cell.split('_d')[0]
    plt.plot(tsdf['T'], D3, label = name)
    
    fontC = "#ffffff"
    plt.xticks(fontsize=25, color = fontC)
    plt.yticks(fontsize=25, color = fontC)
    
    plt.xlabel('Time (secs)', color = fontC, fontsize = 25)
    plt.ylabel('Cortex thickness (nm)', color = fontC, fontsize = 25)
    
    # 
    fig.savefig('G:/CortexMeetings/PielMeeting_24-03-08/Migration/Plots/ThicknessvTime.png')
...
fitsSubDir = 'Chad_f15_MCF10a_24-03_07'
...
GlobalTable = taka.getMergedTable('Chad_f15_MCF10a_24-01-25')
fitsSubDir = 'Chad_f15_MCF10a_24-01-25'
...
dirToSave = 'G:/CortexMeetings/PielMeeting_24-03-08/Migration/Plots'
...
celltypes = ['MCF']
condSelection = celltypes

labels = []

styleDict1 =  {'MCF':{'color':  "#000000",'marker':'o', 'label':'All cells'},
                }

# cellIds = ['24-01-25_M1_P2_C9', '24-01-25_M1_P4_C6', '24-01-25_M2_P4_C2']
# styleDict1 =  {'24-01-25_M1_P2_C9':{'color':  "#0000FF",'marker':'o', 'label':'M1_P2_C9 : Front'},
#                '24-01-25_M1_P4_C6':{'color':  "#4C974C",'marker':'o', 'label':'M1_P4_C6 : Lateral'},
#                '24-01-25_M2_P4_C2':{'color':  "#4C974C",'marker':'o', 'label':'M2_P4_C2 : Lateral'},
#                 }
...
plt.ylim(0,20)
plt.tight_layout()
plt.savefig(dirToSave + '/Nonlinearity/MCF-10a_wholeCurve_Averaged.png')  
plt.show()
plt.close()
...
plt.ylim(0,8)
plt.tight_layout()
plt.savefig(dirToSave + '/Nonlinearity/MCF-10a_Averaged_' + stressRange +'.png')  
plt.show()
...
savePath = dirToSave + '/Thickness_Fluctuations/_'+measure+'_boxplot_averaged_MCF-10a.png'

fig, ax = makeBoxPlots(dfAllCells, measure, condCol, labels = labels, order = order, 
                       condSelection = condSelection, savePath= savePath, average = True)
...
savePath = 'G:/CortexMeetings/PielMeeting_24-03-08/Migration/Plots/E_400pN/MCF-10a_E_400pN.png'


# makeBoxPlots(dfAllCells, measure, condCol, order, labels, condSelection = condSelection, savePath = savePath,
#                    stats = False, average = True)

makeBoxPlots(dfAllCells, measure, condCol, labels, order, condSelection, savePath, colorPalette = None, removeLegend = False,
                 average = True, stats = False)
